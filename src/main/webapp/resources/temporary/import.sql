...
INSERT INTO `mndrnapp`.`genus_synonym_list` (`genus_genus_id`, `synonym_list`) VALUES ('1', 'Genus-2 Species-2');
INSERT INTO `mndrnapp`.`genus_synonym_list` (`genus_genus_id`, `synonym_list`) VALUES ('1', 'Genus-3 Species-3');
INSERT INTO `mndrnapp`.`genus_synonym_list` (`genus_genus_id`, `synonym_list`) VALUES ('1', 'Genus-4 Species-4');
...
#Compound
INSERT INTO `mndrnapp`.`compound` (`id`, `iupacname`, `melting_point`, `name`) VALUES ('1', 'I', '10', 'Compound 1');
